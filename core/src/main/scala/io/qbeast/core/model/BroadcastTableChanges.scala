...
object BroadcastTableChanges {
  ...
  def apply(
      ...
      isOptimizeOperation: Boolean): TableChanges = {
    val sparkContext = SparkSession.active.sparkContext
    BroadcastTableChanges.create(
      revisionChanges,
      existingIndexStatus,
      sparkContext.broadcast(updatedCubeWeights),
  ...
  def create(
      revisionChanges: Option[RevisionChange],
      existingIndexStatus: IndexStatus,
      updatedCubeWeightsBroadcast: Broadcast[Map[CubeId, Weight]],
    ...
    BroadcastTableChanges(
      ...
      isOptimizeOperation = isOptimizeOperation,
      updatedRevision = updatedRevision,
      cubeWeightsBroadcast = updatedCubeWeightsBroadcast,
